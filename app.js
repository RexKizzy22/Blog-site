...
mongoose.connect("mongodb+srv://admin-kizito:Test123@cluster0-mg6qp.mongodb.net/blogDB", {useNewUrlParser: true, useUnifiedTopology: true});
...
const Blog = mongoose.model("Blog", homeSchema);
